...
const ACTIONS = [
  {
    name: "Strong Buy",
    meaning:
      "Multiple independent signals align constructively. The Mentor sees a strong educational case for studying an entry — still not a guarantee of profit.",
  },
  {
    name: "Buy",
    meaning:
      "The evidence leans positive, but the Mentor still expects you to confirm structure and risk before acting.",
  },
  {
    name: "Watch",
    meaning:
      "Something interesting is developing. The Mentor suggests observing price behaviour and waiting for clearer confirmation.",
  },
  {
    name: "Wait",
    meaning:
    ...
    <div data-testid="how-to-use-page">
      <InfoSection title="What TradeLens is">
        <p>
          ...
          combines market data, structured analysis, and Mentor explanations to help you
          understand <em>how</em> experienced traders evaluate a stock — not to tell you
          what to buy or sell.
        </p>
        <p>
          Think of it as a patient mentor: it shows evidence, explains trade-offs, and
      ...
      <InfoSection title="Navigating the application">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 not-prose">
          <InfoCard title="Dashboard">
            ...
            stock you are studying. Select a symbol to open its chart and Mentor view.
          </InfoCard>
          <InfoCard title="Learn">
            You are here. Read how to interpret Mentor classifications, trends, and the
      ...
      <InfoSection title="Mentor classifications (educational context)">
      ...
      <InfoSection title="Using Learn Why">
        <p>
          Learn Why opens the Mentor&apos;s reasoning: what the system sees, supporting
      ...
      <InfoSection title="How to learn from TradeLens">
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>Compare the Mentor explanation with the chart and key levels.</li>
